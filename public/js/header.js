// Header modular tipo Rakuten.tv

const headerHTML = `
<header class="slider-header">
  <div class="slider-header-inner">
    <a href="#" class="slider-logo" aria-label="Inicio">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="43.1499 135.2082 426.2515 101.1976" width="160" height="38">
