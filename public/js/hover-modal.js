class HoverModal {
    ...
    close() {
        ...
        // Start origin scale-down immediately so item and modal animations can run in parallel
        try {
            const origin = this._currentOrigin;
        ...
        // Wait for the modal's hide transition to finish to perform modal-specific cleanup
        try {
