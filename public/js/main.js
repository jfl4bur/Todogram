document.addEventListener('DOMContentLoaded', () => {
    ...
    // Inicializar carruseles adicionales (ejemplo para futuras implementaciones)
    /*
    const carruselSeries = new Carousel('carrusel-series', seriesData, 'Series Destacadas');
    const carruselAnimes = new Carousel('carrusel-animes', animesData, 'Animes Populares');
    */
});